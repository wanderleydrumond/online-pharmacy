...
a persistence unit "frontendPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "frontend\pom.xml":
...
artifact ("frontend.war") is already built. You can build
