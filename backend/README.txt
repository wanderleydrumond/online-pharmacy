...
a persistence unit "backendPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "backend\pom.xml":
...
artifact ("backend.war") is already built. You can build
